...
public class Player : MonoBehaviour, IPlayer
{
    ...
    [Header("Кнопка для установки бомбы")]
    [SerializeField] private KeyCode keyCodeBomb;
    ...
    private int currentNumberOfBomb = 0;
    ...
    private void Update()
    {
        if (Input.GetKeyDown(keyCodeBomb) && currentNumberOfBomb > 0) SetBomb();
    }
